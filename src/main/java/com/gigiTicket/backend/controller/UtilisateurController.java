...
public class UtilisateurController {
	...
	public ResponseEntity<List<Utilisateur>> listerActifs() {
	...
	public ResponseEntity<Utilisateur> modifier(@PathVariable Integer id, @RequestBody Utilisateur utilisateur) {
	...
	@Parameter(name = "id", description = "ID de l'utilisateur", example = "1", required = true)
	public ResponseEntity<Utilisateur> activer(@PathVariable Integer id) {
	...
	@Parameter(name = "id", description = "ID de l'utilisateur", example = "1", required = true)
	public ResponseEntity<Utilisateur> desactiver(@PathVariable Integer id) {
